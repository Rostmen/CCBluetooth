...
class AmbTests: XCTestCase {
    ...
    func testAmbEmptyAndEmpty() {
        ...
        Publishers
            .Amb(left: subject1, right: subject2)
            .sink(receiveCompletion: { completion = $0 },
                  receiveValue: { values.append($0) })
            .store(in: &subscriptions)
    ...
    static var allTests = [
        ("testAmbValues", testAmbValues),
        ("testAmbLimitedPreDemand", testAmbLimitedPreDemand),
        ("testAmbEmptyAndNever", testAmbEmptyAndNever),
        ("testAmbEmptyAndEmpty", testAmbEmptyAndEmpty),
        ("testAmbNeverAndNever", testAmbNeverAndNever),
        ("testAmbVariadicValues", testAmbVariadicValues),
        ("testAmbCollectionNone", testAmbCollectionNone),
        ("testAmbCollectionOne", testAmbCollectionOne),
        ("testAmbCollectionMany", testAmbCollectionMany),
    ]
}
